...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['logout'])) {
    ...
    $environmental_concerns = $_POST['environmental_concerns'];

    $sql = "INSERT INTO environmental_support (age, gender, request_type, environmental_concerns) 
            VALUES (?, ?, ?, ?)";

    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "isss", $age, $gender, $request_type, $environmental_concerns);
...
<div class="container">
    ...
    <div class="card">
        ...
        <h2 style="font-size: 30px;">Environmental Form</h2>
        <form action="es.php" method="post">
            ...
            <div class="clear"></div>
            <div class="input-group">
                <label for="request_type">Request Type Please Select type of Report:</label>
                <select id="request_type" name="request_type" required>
                    <option value="Tree Planting Event">Tree Planting Event</option>
                    <option value="Waste Management Support">Waste Management Support</option>
                    <option value="Others">Others</option>
                </select>
            </div>
            <div class="input-group">
                <label for="environmental_concerns">Environmental Concerns:</label>
                <textarea id="environmental_concerns" name="environmental_concerns" rows="4"></textarea>
            </div>
            <div class="clear"></div>
