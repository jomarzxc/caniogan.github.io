...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO no_income_declaration (age, gender, source, reason, documentation) 
            VALUES (?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "issss", $age, $gender, $source, $reason, $documentation);
...
<div class="container">
    ...
    <a href="dashboard.php"><img src="images/caniogan.jpg" alt=""></a>
        ...
        <form class="logout-btn" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <button type="submit" name="logout" class="logout-button">Logout</button>
        </form>
    </div>
    <div class="card">
        <h2>No Income Declaration</h2>
        <div class="clear"></div>
        <form action="nid.php" method="post">
            ...
            <div class="input-group">
                <label for="reason">Reason for No Income:</label>
                <input type="text" id="reason" name="reason" required>
            </div>
            <div class="clear"></div>
            <div class="input-group">
                <label for="documentation">Documentation</label>
                <input type="text" id="documentation" name="documentation" required>
            </div>
            <div class="clear"></div>
            <div>
