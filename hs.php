...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO health_service (age, gender, participation, concerns) 
            VALUES (?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "isss", $age, $gender, $participation, $concerns);
...
<div class="container">
    ...
    <div class="card">
        ...
        <form action="hs.php" method="post">
            ...
            <div class="clear"></div>
            <div class="input-group">
                <label for="participation">Health Programs Participation:</label>
                <input type="text" id="participation" name="participation" required>
            </div>
            <div class="input-group">
                <label for="concerns">Concerns:</label>
                <input type="text" id="concerns" name="concerns" required>
            </div>
            <div>
