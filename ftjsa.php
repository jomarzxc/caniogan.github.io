...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $SoQ = $_POST['SoQ'];
    $job_preferences = $_POST['job_preferences'];
    $job_position = $_POST['job_position'];

    $sql = "INSERT INTO first_time_job_seekers_assistance (age, gender, educational_background, employment_history, first_time, SoQ, job_preferences, job_position) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "isssssss", $age, $gender, $educational_background, $employment_history, $first_time, $SoQ, $job_preferences, $job_position);
...
<div class="container">
    ...
    <div class="card">
        <h2>First Time Job Seekers Assistance</h2>
        <div class="clear"></div>
<form action="ftjsa.php" method="post">
            ...
            <div class="input-group">
                ...
                <input type="text" id="employment_history" name="employment_history" required>
            </div>
            <div class="clear"></div>
            <div class="input-group">
                <label for="first_time">First Time:</label>
                <input type="text" id="first_time" name="first_time" required>
            </div>
            <div class="input-group">
                <label for="SoQ">Skills and Qualifications:</label>
                <input type="text" id="SoQ" name="SoQ" required>
            </div>
            <div class="clear"></div>
            <div class="input-group">
                <label for="job_preferences">Job Preferences:</label>
                <input type="text" id="job_preferences" name="job_preferences" required>
            </div>
            <div class="input-group">
                <label for="job_position">Preferred Job Position:</label>
